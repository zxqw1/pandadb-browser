<template>
        ...
        >
          <div class="topIcon">
            <PushpinOutlined
              ...
              :style="{
              color:isTop ? 'rgb(108, 125, 46)' : '#666666',
              backgroundColor: isTop ? 'rgb(228 228 228)' :'#ffffff',
            }"
  ...
  watch(store.state.topList, async (newVal, oldVal) => {
    ...
    if (
      ...
      // console.log(topList, 839);
      graphList.value.push(topList);
      oldVal.map((item, index) => {
